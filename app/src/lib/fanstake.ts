 ...
 * IDL can be found at `target/idl/fanstake.json`.
 */
export type Fanstake = {
  "address": "JCAt7JFiHxMBQ9TcEZYbWkp2GZpF3ZbdYdwD5ZBP6Nkf",
  "metadata": {
    "name": "fanstake",
    "version": "0.1.0",
    "spec": "0.1.0",
    "description": "FanStake — The stock market for music artists"
  },
  "docs": [
